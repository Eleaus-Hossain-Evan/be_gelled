...
import '../domain/message/message_list_response.dart';
import '../domain/message/message_send/message_send_body.dart';
import '../domain/message/message_send/message_send_response.dart';
import '../domain/message/message_view/message_view_response.dart';
...
class ChatRepo {
  ...
  Future<Either<CleanFailure, MessageViewResponse>> allMessageView(String id,
      {int page = 1}) async {
    final data = await myApi.get(
      fromData: (json) => MessageViewResponse.fromMap(json),
      endPoint: "${APIRoute.MESSAGE_VIEW}$id?page=$page",
      withToken: true,
    );
