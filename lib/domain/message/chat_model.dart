...
class ChatModel extends Equatable {
  final String id;
  final CustomerInfoModel sender;
  final String senderMsgBy;
  final CustomerInfoModel receiver;
  ...
  ChatModel copyWith({
    String? id,
    CustomerInfoModel? sender,
    String? senderMsgBy,
    CustomerInfoModel? receiver,
  ...
  factory ChatModel.fromMap(Map<String, dynamic> map) {
    return ChatModel(
      id: map['_id'] ?? '',
      sender: CustomerInfoModel.fromMap(map['sender']),
      senderMsgBy: map['senderMsgBy'] ?? '',
      receiver: CustomerInfoModel.fromMap(map['receiver']),
  ...
  @override
  String toString() {
    return 'ChatModel(id: $id, sender: $sender, senderMsgBy: $senderMsgBy, receiver: $receiver, receiverMsgBy: $receiverMsgBy, message: $message, msgSendingTime: $msgSendingTime, messageSeen: $messageSeen, msgSeenTime: $msgSeenTime, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
